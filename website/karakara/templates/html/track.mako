    ...
    % else:
        ...
        % if queue_status != 'THRESHOLD':
            <form action='${paths['queue_items']}' method='POST' data-ajax="false" onsubmit="store_performer_name();">
                ...
                <input type='text'   name='performer_name' value=''              id="input_performer_name" placeholder='${request.queue.settings.get('karakara.template.input.performer_name') or _('view.track.input.performer_name.default')}' required />
