...
Core Components
---------------
* [upload](upload/README.md) [![Upload](https://github.com/shish/karakara/actions/workflows/upload.yml/badge.svg?branch=master)](https://github.com/shish/karakara/actions/workflows/upload.yml)
  * Accept all sorts of media files and metadata
  * Store them in a folder
* [processmedia3](processmedia3/README.md) [![ProcessMedia3](https://github.com/shish/karakara/actions/workflows/processmedia3.yml/badge.svg?branch=master)](https://github.com/shish/karakara/actions/workflows/processmedia3.yml)
...
* [browser3](browser3/README.md) [![Browser3](https://github.com/shish/karakara/actions/workflows/browser3.yml/badge.svg?branch=master)](https://github.com/shish/karakara/actions/workflows/browser3.yml)
