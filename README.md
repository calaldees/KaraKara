...
Core Components
---------------
* [upload](upload/README.md) [![Upload](https://github.com/calaldees/KaraKara/workflows/Upload/badge.svg?branch=master)](https://github.com/calaldees/KaraKara/actions/workflows/upload.yml)
  * Accept all sorts of media files and metadata
  * Store them in a folder
* [processmedia3](processmedia3/README.md) [![ProcessMedia3](https://github.com/calaldees/KaraKara/workflows/ProcessMedia3/badge.svg?branch=master)](https://github.com/calaldees/KaraKara/actions/workflows/processmedia3.yml)
...
* [browser3](browser3/README.md) [![Browser3](https://github.com/calaldees/KaraKara/workflows/Browser3/badge.svg?branch=master)](https://github.com/calaldees/KaraKara/actions/workflows/browser3.yml)
  * Mobile app to browse the data in `tracks.json`
  * Users can send tracks to the queue
* [api_queue](api_queue/README.md) [![ApiQueue](https://github.com/calaldees/KaraKara/workflows/ApiQueue/badge.svg?branch=master)](https://github.com/calaldees/KaraKara/actions/workflows/api_queue.yml)
  * Takes requests from users and commands from admins
  * Publishes the current queue to the player
* [player3](player3/README.md) [![Player3](https://github.com/calaldees/KaraKara/workflows/Player3/badge.svg?branch=master)](https://github.com/calaldees/KaraKara/actions/workflows/player3.yml)
