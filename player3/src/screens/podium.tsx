            ...
            {starting ? (
                ...
                queue_item.start_time < now ? (
                    ...
                    >
                        Track Playing
                        <small>
                            ({s_to_mns(now - queue_item.start_time)} / {s_to_mns(track.duration)})
                        </small>
                    </div>
                ) : (
                    <div
                        ...
                        onClick={(e) => start()}
                        style={{
                            backgroundPosition: percent(queue_item.start_time - now, settings["track_space"]),
                        }}
                    >
                        <span>
                            Tap Here to Start
                            <small>Track autoplays in {s_to_mns(queue_item.start_time - now)}</small>
                        </span>
                    </div>
                )
            ) : (
