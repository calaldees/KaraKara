...
def test_no_reorder_protect_coming_soon_track_count(qu):
    qu.add(
        QueueItem(
            "Track1", ONE_MINUTE, "TestSession1", "test_name1", added_time=_mins_ago(60), start_time=_mins_ago(10)
        )
    )
    qu.add(
        QueueItem("Track2", ONE_MINUTE, "TestSession2", "test_name2", added_time=_mins_ago(50), start_time=_mins_ago(5))
    )
    qu.add(QueueItem("Track3", ONE_MINUTE, "TestSession3", "test_name3", added_time=_mins_ago(40)))
    qu.add(QueueItem("Track4", ONE_MINUTE, "TestSession1", "test_name4", added_time=_mins_ago(30)))
    qu.add(
        QueueItem("Track11", ONE_MINUTE, "TestSession1", "test_name1", added_time=_mins_ago(20))
