...
export function FetchRandomImages(state: State) {
    return Http({
        ...
        error(state: State, response) {console.log("Error fetching random images:", response); return {...state}}
    });
}
...
export function CheckSettings(state: State) {
    return Http({
        ...
        error(state: State, response) {console.log("Error checking settings:", response); return {...state}}
    });
}
...
export function CheckQueue(state: State) {
    return Http({
        ...
        error(state: State, response) {console.log("Error checking queue:", response); return {...state}}
    });
}
...
export function SetTrackState(state: State, value: string) {
    return Http({
        ...
        action(state: State, response) {return state},
        error(state: State, response) {console.log("Error setting track state:", response); return {...state}}
    });
}
